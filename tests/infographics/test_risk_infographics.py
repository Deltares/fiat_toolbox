...
class TestRiskInfographicsParserGetMetrics(unittest.TestCase):
    ...
    def test_get_impact_metrics(
        ...
        # Act
        parser = RiskInfographicsParser(scenario_name="test_scenario", 
...
class TestRiskInfographicsParserChartsFigure(unittest.TestCase):
    ...
    def test_figure_to_html(self, mock_open, mock_to_html, mock_path_exists):
        ...
        metrics = {'ExpectedAnnualDamages': 1000000,
                   'FloodedHomes': 1000}
        charts = {'Other': {'expected_damage_image': 'expected_damage_image.png',
        ...
        self.assertEqual(str(mock_path_exists.call_args_list[0][0][0]), str(figure_path))
        self.assertEqual(str(mock_path_exists.call_args_list[1][0][0]), str(figure_path.parent))

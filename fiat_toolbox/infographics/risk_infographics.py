                ...
                <body>
                    <div class="container">
                        <div class="inner-div">
                            ...
                            <p1>${"{:,.0f}".format(metrics[charts["Other"]["Expected_Damages"].get("query", "ExpectedAnnualDamages")])}</p1>
                        </div>
                        <div class="inner-div">
                            ...
                            <p2>{"{:,.0f}".format(metrics[charts["Other"]["Flooded"].get("query", "FloodedHomes")])}</p2>
                        </div>

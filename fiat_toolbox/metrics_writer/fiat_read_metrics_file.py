...
class IMetricsFileReader(ABC):
    ...
    def read_metrics_from_file(self, metric: str) -> pd.Series:
        ...
        Args:
            metric (str): The metric to read from the file.

        Returns:
            pd.DataFrame: The metrics read from the file.

        Raises:
            KeyError: If the metric is not found in the file.
        """
...
class MetricsFileReader(IMetricsFileReader):
    ...
    def __init__(self, metrics_file_path: str): 
        ...
        Args:
            metrics_file_path (str): The path to the file containing the metrics.
        
        Raises:
            FileNotFoundError: If the file cannot be found. 
            ValueError: If the file is not a valid metrics file
        """
    ...
    def read_aggregated_metric_from_file(self, metric: str) -> Dict:
        ...
        Returns:
            Dict: The metrics read from the file.  
